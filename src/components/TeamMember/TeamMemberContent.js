export default {
  ...
  pierre: {
    ...
    intro: "Pierre’s interests broadly lie in quantitative methods applied to infectious disease epidemiology.",
    body: [
  ...
  emily: {
    name: "Emily Cohn, MPH",
    org: "HealthMap",
    intro: "Emily is the Manager of Strategy and Digital Innovation Operations for HealthMap, the Computational Epidemiology Group and the Innovation and Digital Health Accelerator at Boston Children’s Hospital. ",
    body: [
  ...
  clark: {
    ...
    org: "HealthMap",
    intro: "Clark is an Assistant Teaching Professor of Computer Science at Northeastern University, and Affiliate Faculty at Boston Children's Hospital.",
    body: [
  ...
  jared: {
    ...
    org: "HealthMap",
    intro: "Jared is the Director of Technology and Product at Boston Children’s Hospital Innovation and Digital Health Accelerator and a faculty member in the Computational Health Informatics Program.",
    body: [
  ...
  moritz: {
    ...
    org: "HealthMap",
    intro: "Moritz's research addresses questions related to the spatial spread of infectious diseases.",
    body: [
  ...
  britta: {
    ...
    org: "ProMED",
    intro: "Britta is an Infectious Diseases physician with an interest in international knowledge transfer and the global exchange and sharing of best medical practices through digital technology.",
    body: [
  ...
  angel: {
    ...
    org: "ProMED",
    intro: "Angel is an Infectious Diseases physician interested in leveraging informal surveillance methodologies for emerging diseases and outbreaks, particularly among displaced and other vulnerable populations.",
    body: [
  ...
  lawrence: {
    ...
    org: "ProMED",
    intro: "Larry is an infectious disease physician specializing in the epidemiology of emerging pathogens, bacterial pathogenesis, and international health.",
    body: [
  ...
  johnr: {
    ...
    org: "ProMED",
    intro:
      "John is the Assistant Program Director at ISID with a background in Public Health, One Health, and Infectious Diseases.",
    body: [
      "He has conducted field research on antimicrobial resistance and treatment failure experiences within human and veterinary sectors in Uganda, infectious disease outbreak surveillance related to the movement of displaced populations, and HIV intervention program analysis in South Africa.",
    ],
